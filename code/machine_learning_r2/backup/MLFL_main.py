class access_data:
	...
	data_profile = '/Users/m221138/RA_project/code/machine_learning_r1/file_locations.txt'
...
class feature_selection:
	...
	def full_feature_selection(self, folder_list, summary_folder, data_splits):
		...
		for folder_name in folder_list:
			for index in range(1, data_splits + 1):
				...
				out_file_txt = '%s/%s.ml.ready.txt' % (summary_folder, index)
				out_file_txt = open(out_file_txt,'w')
	...
	def do_lmer(self, file_name, data_profile):
		...
		os.system('Rscript /Users/m221138/RA_project/code/machine_learning_r1/MLR_R_lmer.r %s %s' % (data_profile, out_dir))
	...
	def cv_ready_matrix_step_b(self, folder_list, summary_folder, data_splits):
		...
		for index in range(1, data_splits + 1):
			...
			for i in range(len(feature_list_readlines)):
				...
				ith_data_test_dict = self.cv_ready_matrix_step_b_submodule(ith_feature_file, ith_df_test_file, ith_data_dict)
