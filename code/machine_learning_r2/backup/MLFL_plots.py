class plots:
	...
	def plot_loo_mae_variance_plot(self, loo_mae_dict, summary_file):
		...
		summary_sns_plot.set(xlabel='Index of sample set', ylabel='Mean Absolute Error')
