class access_data:
	...
	data_profile = '../code/machine_learning_r2/file_locations.txt'
...
class feature_selection:
	...
	def do_lmer(self, file_name, data_profile):
		...
		print (file_name)
		#os.system('Rscript /Users/m221138/RA_project/code/machine_learning_r2/MLR_R_lmer.r %s %s' % (data_profile, out_dir))
		os.system('Rscript ../code/machine_learning_r2/MLR_R_lmer.r %s %s' % (data_profile, out_dir))
